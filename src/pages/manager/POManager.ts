...
export class POManager {
    ...
    get contactUsPage(): ContactUsPage { return this._contactUs ??= new ContactUsPage(this.page); }
    get TestCasesPage(): TestCasePage { return this._testCase ??= new TestCasePage(this.page); }
