...
export class SignUpLocators {
  ...
  // Headings
  readonly accountInfoHeading = this.page.getByRole('heading', {
  ...
  // Checkboxes
  readonly newsletterCheckbox = this.page.getByRole('checkbox', {
    name: 'Sign up for our newsletter!',
  });
  readonly offersCheckbox = this.page.getByRole('checkbox', {
