...
export class ContactUsLocators {
  ...
  readonly feedback1Text = this.page.locator('p:has-text("We really appreciate your response to our website.")');
  readonly feedback2Text = this.page.locator('p:has-text("Kindly share your feedback with us at feedback@automationexercise.com.")');
  readonly feedback3Text = this.page.locator('p:has-text("If you have any suggestion areas or improvements, do let us know. We will definitely work on it.")');
