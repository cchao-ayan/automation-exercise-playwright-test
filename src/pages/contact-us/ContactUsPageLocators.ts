...
export const locators = {
  contactUsSection: (page: Page) =>
    page.getByRole("heading", { name: "Contact Us", level: 2 }),
  getInTouchHeading: (page: Page) =>
  ...
  homeButton: (page: Page) =>
    page.locator('a.btn.btn-success >> span:has-text("Home")'),
};
