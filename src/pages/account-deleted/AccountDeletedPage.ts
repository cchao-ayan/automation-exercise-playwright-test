...
export class AccountDeletedPage extends BasePage {
    ...
    async verifyText2isVisible() {
        ...
        await this.expectHaveText(text2Locator, 'You can create new account to take advantage of member privileges to enhance your online shopping experience with us.');
    }
