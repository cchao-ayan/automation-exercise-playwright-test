...
import { LoginPage } from '@playwright-features/auth/pages/login.page';
import { HomePage } from '@playwright-features/home/pages/home.page';
import { SignUpPage } from '@playwright-features/auth/pages/signup.page';
import { AccountCreatedPage } from '@playwright-features/auth/pages/account-created.page';
import { AccountDeletedPage } from '@playwright-features/auth/pages/account-deleted.page';
import { ContactUsPage } from '@playwright-features/contact-us/pages/contact-us.page';
import { TestCasePage } from '@playwright-features/exercises/pages/test-case.page';
import { ProductsPage } from '@playwright-features/products/pages/product.page';
import { ProductDetailsPage } from '@playwright-features/products/pages/product-details.page';
import { CartPage } from '@playwright-features/cart/pages/view-cart.page';
import { CheckOutPage } from '@playwright-features/checkout/pages/checkout.page';
import { PaymentPage } from '@playwright-features/checkout/pages/payment.page';
import { PaymentDonePage } from '@playwright-features/checkout/pages/payment-done.page';
